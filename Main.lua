...
-- ============================================================================
-- 5. CALLBACK FUNCTIONS (FIXES INLINE SYNTAX BUG IN EXECUTORS)
-- ============================================================================
local function AimbotKeybindCallback(Key, KeyDown)
    Aimbot = Window.Flags["Aimbot/Enabled"] and KeyDown
end

local function TriggerKeybindCallback(Key, KeyDown)
    Trigger = Window.Flags["Trigger/Enabled"] and KeyDown
end

-- ============================================================================
-- 6. INTERFACE COMPOSER (TABS & SECTIONS)
-- ============================================================================
...
AimbotSection:Toggle({Name = "Enabled", Flag = "Aimbot/Enabled", Value = false})
    :Keybind({Flag = "Aimbot/Keybind", Value = "MouseButton2", Mouse = true, DisableToggle = true, Callback = AimbotKeybindCallback})
...
local PriorityList = {{Name = "Closest", Mode = "Button", Value = true}}
local BodyPartsList = {}
...
TriggerSection:Toggle({Name = "Enabled", Flag = "Trigger/Enabled", Value = false})
    :Keybind({Flag = "Trigger/Keybind", Value = "MouseButton2", Mouse = true, DisableToggle = true, Callback = TriggerKeybindCallback})
